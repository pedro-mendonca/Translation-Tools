...
if ( ! class_exists( __NAMESPACE__ . '\Update_Core' ) ) {
	...
	class Update_Core {
		...
		public function update_core_bottom_section() {
			...
			echo '<strong>' . esc_html__( 'Needed Translations:', 'translation-tools' ) . '</strong> ' . implode( ', ', $this->options_general->needed_translations() ) . '<br>';

			echo '<strong>' . esc_html__( 'Missing Translations:', 'translation-tools' ) . '</strong> ' . implode( ', ', $this->options_general->missing_translations() ) . '<br>';

			echo '<strong>' . esc_html__( 'Installed Translations:', 'translation-tools' ) . '</strong> ' . implode( ', ', $this->options_general->installed_translations() ) . '<br>';

			echo '<strong>' . esc_html__( 'Unused Translations:', 'translation-tools' ) . '</strong> ' . implode( ', ', $this->options_general->unused_translations() ) . '<br>';
			// var_dump( $this->options_general->unused_translations() );


			// var_dump( $this->options_general->missing_translations() );
		}
