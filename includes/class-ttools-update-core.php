...
if ( ! class_exists( 'TTools_Update_Core' ) ) {
	...
	class TTools_Update_Core {
		...
		public function __construct() {
			...
			add_action( 'admin_notices', array( $this, 'dashboard_wp_translation_notice' ) );
		 ...
		 * @return void
		 */
		public function dashboard_wp_translation_notice() {
			...
			$admin_notice = array(
				...
				'extra-html'  => $this->form_update_wordpress_translation(),
			);
